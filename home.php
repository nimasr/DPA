        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                            ...
                            <div class="card">
                                <div class="card-body bg-warning">
                                    <div class="card-body text-white">
                                        ...
                                        <h4><b>
                                            <?php echo $conn->query("SELECT * FROM formulir_bimbingan")->num_rows; ?>
                                        </b></h4>
                                        <p><a href="index.php?page=formulir"><b>Formulir Bimbingan</b></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body bg-warning">
                                    <div class="card-body text-white">
                                        ...
                                        <p><a href="index.php?page=add"><b>Jadwal Diskusi</b></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body bg-warning">
                                    <div class="card-body text-white">
                                        ...
                                        <h4><b>
                                            <?php echo $conn->query("SELECT * FROM mahasiswa GROUP BY nama_dos ORDER BY nama_dos ASC")->num_rows; ?>
                                        </b></h4>
                                        <p><a href="index.php?page=bimbingan"><b>Dosen</b></a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                    <?php
                     $tags = $conn->query("SELECT * FROM categories order by name asc limit 4");
